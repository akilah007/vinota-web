...
@Component({
  selector: 'app-vinota-security-policy',
  templateUrl: './vinota-security-policy.component.html',
  styleUrls: ['./vinota-security-policy.component.scss']
})
export class VinotaSecurityPolicyComponent {
